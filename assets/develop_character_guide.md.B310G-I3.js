...
<span class="line"><span>|-自信.png</span></span></code></pre></div><h3 id="_3-settings-txt-准备" tabindex="-1">3. settings.txt 准备 <a class="header-anchor" href="#_3-settings-txt-准备" aria-label="Permalink to &quot;3. settings.txt 准备&quot;">​</a></h3><p>核心文件 <code>settings.txt</code> 文件保存了一个角色所有的显示信息和性格等。以下是设定的详细说明（如果想直接复制使用 <strong>一定记得删除 # 号之后的注释！！</strong> ）：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>title = 星空列车-音理            # 用于设定人物卡片标题</span></span>
...
<span class="line"><span>……略</span></span></code></pre></div>`,41)),n(p),n(e)])}const b=l(c,[["render",u]]);export{v as __pageData,b as default};
